...
set_property -dict [list CONFIG.inputWidth {11} CONFIG.numInputs {4}] [get_bd_cells SumJunction]
...
set_property -dict [list CONFIG.NUM_PORTS {4} CONFIG.IN0_WIDTH {11} CONFIG.IN1_WIDTH {11} CONFIG.IN2_WIDTH {11} CONFIG.IN3_WIDTH {11}] [get_bd_cells SumJunctionConcat]
