...
set_property -dict [list CONFIG.address {0} CONFIG.addressWidth {3} CONFIG.dataWidth {16} CONFIG.padHighWidth {-2} CONFIG.padLowWidth {-3}] [get_bd_cells BiasRegister]


set_property -dict [list CONFIG.DIN_WIDTH {11} CONFIG.DIN_FROM {7} CONFIG.DIN_TO {0}] [get_bd_cells PlanSlicer]


set_property -dict [list CONFIG.latency {7}] [get_bd_cells ValidSetter]
set_property -dict [list CONFIG.inputWidth {11} CONFIG.numInputs {6}] [get_bd_cells SumJunction]
...
set_property -dict [list CONFIG.NUM_PORTS {6} CONFIG.IN0_WIDTH {11} CONFIG.IN1_WIDTH {11} CONFIG.IN2_WIDTH {11} CONFIG.IN3_WIDTH {11} CONFIG.IN4_WIDTH {11} CONFIG.IN5_WIDTH {11}] [get_bd_cells SumJunctionConcat]
set_property -dict [list CONFIG.integerPrecision {3} CONFIG.fractionPrecision {7}] [get_bd_cells Plan]


set_property -dict [list CONFIG.address {1} CONFIG.addressWidth {3} CONFIG.dataWidth {16}] [get_bd_cells WeightRegister_0]


set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {20} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_0]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {8} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {23}] [get_bd_cells Multiplier_0]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {20} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_1]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {20} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_2]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {20} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_3]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {20} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_4]
