...
set_property -dict [list CONFIG.packetOutWidth {3} CONFIG.packetInWidth {21}] [get_bd_cells TypeRouter_Stimulus]
set_property -dict [list CONFIG.CONST_WIDTH {18} CONFIG.CONST_VAL {131072}] [get_bd_cells TypeRouter_Stimulus_Address]
...
set_property -dict [list CONFIG.NUM_PORTS {5} CONFIG.IN0_WIDTH {1} CONFIG.IN1_WIDTH {1} CONFIG.IN2_WIDTH {1} CONFIG.IN3_WIDTH {1} CONFIG.IN4_WIDTH {1}] [get_bd_cells SynOutConcat]
set_property -dict [list CONFIG.numInputs {5} CONFIG.dinWidth {1} CONFIG.doutWidth {32}] [get_bd_cells SynOutBuffer]
...
set_property -dict [list CONFIG.address {0} CONFIG.addressWidth {2} CONFIG.dataWidth {1}] [get_bd_cells StimulusRegister_0]


set_property -dict [list CONFIG.address {1} CONFIG.addressWidth {2} CONFIG.dataWidth {1}] [get_bd_cells StimulusRegister_1]


set_property -dict [list CONFIG.address {2} CONFIG.addressWidth {2} CONFIG.dataWidth {1}] [get_bd_cells StimulusRegister_2]
