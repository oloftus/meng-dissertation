...
create_bd_cell -type ip -vlnv oloftus.com:prif:Shifter:1.0 Shifter_3
...
create_bd_cell -type ip -vlnv oloftus.com:prif:Shifter:1.0 Shifter_4
...
set_property -dict [list CONFIG.weightWidth {12} CONFIG.transferWidth {8} CONFIG.valueWidth {12} CONFIG.shiftWidth {5}] [get_bd_cells Shifter_3]
...
set_property -dict [list CONFIG.weightWidth {12} CONFIG.transferWidth {8} CONFIG.valueWidth {12} CONFIG.shiftWidth {5}] [get_bd_cells Shifter_4]
...
connect_bd_net [get_bd_pins WeightRegister_3/VAL_OUT] [get_bd_pins Shifter_3/SHIFT]
...
connect_bd_net [get_bd_pins Synapse_3/SYN_OUT] [get_bd_pins Shifter_3/DIN]
connect_bd_net [get_bd_pins Shifter_3/DOUT] [get_bd_pins SumJunctionConcat/In4]
...
connect_bd_net [get_bd_pins WeightRegister_4/VAL_OUT] [get_bd_pins Shifter_4/SHIFT]
...
connect_bd_net [get_bd_pins Synapse_4/SYN_OUT] [get_bd_pins Shifter_4/DIN]
connect_bd_net [get_bd_pins Shifter_4/DOUT] [get_bd_pins SumJunctionConcat/In5]
