...
set_property -dict [list CONFIG.packetOutWidth {10} CONFIG.packetInWidth {21}] [get_bd_cells TypeRouter_Stimulus]
set_property -dict [list CONFIG.CONST_WIDTH {11} CONFIG.CONST_VAL {1024}] [get_bd_cells TypeRouter_Stimulus_Address]
