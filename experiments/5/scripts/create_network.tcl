...
set_property -dict [list CONFIG.packetOutWidth {12} CONFIG.packetInWidth {13}] [get_bd_cells TypeRouter_Weight]
...
set_property -dict [list CONFIG.DIN_WIDTH {32} CONFIG.DIN_TO {0} CONFIG.DIN_FROM {12}] [get_bd_cells PacketInSlicer]
set_property -dict [list CONFIG.packetOutWidth {10} CONFIG.packetInWidth {13}] [get_bd_cells TypeRouter_Stimulus]
set_property -dict [list CONFIG.CONST_WIDTH {3} CONFIG.CONST_VAL {4}] [get_bd_cells TypeRouter_Stimulus_Address]
...
set_property -dict [list CONFIG.packetOutWidth {10} CONFIG.packetInWidth {12}] [get_bd_cells LayerRouter_0]
...
set_property -dict [list CONFIG.packetOutWidth {10} CONFIG.packetInWidth {12}] [get_bd_cells LayerRouter_1]
