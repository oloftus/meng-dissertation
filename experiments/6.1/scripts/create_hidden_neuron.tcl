...
set_property -dict [list CONFIG.DIN_WIDTH {22} CONFIG.DIN_FROM {19} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_3]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {6} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {21}] [get_bd_cells Multiplier_3]
...
set_property -dict [list CONFIG.DIN_WIDTH {22} CONFIG.DIN_FROM {19} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_4]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {6} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {21}] [get_bd_cells Multiplier_4]
