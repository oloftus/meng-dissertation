...
create_bd_port -dir O -from 3 -to 0 -type data SYN_OUT
create_bd_port -dir O SYN_OUT_VALID


create_bd_port -dir I SYN_0_VALID
create_bd_port -dir I -from 3 -to 0 -type data SYN_0_DIN


create_bd_port -dir I SYN_1_VALID
create_bd_port -dir I -from 3 -to 0 -type data SYN_1_DIN


create_bd_port -dir I SYN_2_VALID
create_bd_port -dir I -from 3 -to 0 -type data SYN_2_DIN


create_bd_port -dir I SYN_3_VALID
create_bd_port -dir I -from 3 -to 0 -type data SYN_3_DIN


create_bd_port -dir I SYN_4_VALID
create_bd_port -dir I -from 3 -to 0 -type data SYN_4_DIN
...
set_property -dict [list CONFIG.address {0} CONFIG.addressWidth {3} CONFIG.dataWidth {16} CONFIG.padHighWidth {-1} CONFIG.padLowWidth {-7}] [get_bd_cells BiasRegister]


set_property -dict [list CONFIG.DIN_WIDTH {8} CONFIG.DIN_FROM {3} CONFIG.DIN_TO {0}] [get_bd_cells PlanSlicer]


set_property -dict [list CONFIG.latency {7}] [get_bd_cells ValidSetter]
set_property -dict [list CONFIG.inputWidth {8} CONFIG.numInputs {6}] [get_bd_cells SumJunction]
...
set_property -dict [list CONFIG.NUM_PORTS {6} CONFIG.IN0_WIDTH {8} CONFIG.IN1_WIDTH {8} CONFIG.IN2_WIDTH {8} CONFIG.IN3_WIDTH {8} CONFIG.IN4_WIDTH {8} CONFIG.IN5_WIDTH {8}] [get_bd_cells SumJunctionConcat]
set_property -dict [list CONFIG.integerPrecision {4} CONFIG.fractionPrecision {3}] [get_bd_cells Plan]


set_property -dict [list CONFIG.address {1} CONFIG.addressWidth {3} CONFIG.dataWidth {16}] [get_bd_cells WeightRegister_0]


set_property -dict [list CONFIG.DIN_WIDTH {20} CONFIG.DIN_FROM {17} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_0]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {4} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {19}] [get_bd_cells Multiplier_0]


set_property -dict [list CONFIG.size {4}] [get_bd_cells Synapse_0]


set_property -dict [list CONFIG.address {2} CONFIG.addressWidth {3} CONFIG.dataWidth {16}] [get_bd_cells WeightRegister_1]


set_property -dict [list CONFIG.DIN_WIDTH {20} CONFIG.DIN_FROM {17} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_1]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {4} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {19}] [get_bd_cells Multiplier_1]


set_property -dict [list CONFIG.size {4}] [get_bd_cells Synapse_1]


set_property -dict [list CONFIG.address {3} CONFIG.addressWidth {3} CONFIG.dataWidth {16}] [get_bd_cells WeightRegister_2]


set_property -dict [list CONFIG.DIN_WIDTH {20} CONFIG.DIN_FROM {17} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_2]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {4} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {19}] [get_bd_cells Multiplier_2]


set_property -dict [list CONFIG.size {4}] [get_bd_cells Synapse_2]


set_property -dict [list CONFIG.address {4} CONFIG.addressWidth {3} CONFIG.dataWidth {16}] [get_bd_cells WeightRegister_3]


set_property -dict [list CONFIG.DIN_WIDTH {20} CONFIG.DIN_FROM {17} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_3]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {4} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {19}] [get_bd_cells Multiplier_3]


set_property -dict [list CONFIG.size {4}] [get_bd_cells Synapse_3]


set_property -dict [list CONFIG.address {5} CONFIG.addressWidth {3} CONFIG.dataWidth {16}] [get_bd_cells WeightRegister_4]


set_property -dict [list CONFIG.DIN_WIDTH {20} CONFIG.DIN_FROM {17} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_4]
set_property -dict [list CONFIG.Multiplier_Construction {Use_LUTs} CONFIG.PortAWidth.VALUE_SRC USER CONFIG.PortBWidth.VALUE_SRC USER CONFIG.PortAWidth {4} CONFIG.PortBWidth {16} CONFIG.PortAType.VALUE_SRC USER CONFIG.PortBType.VALUE_SRC USER CONFIG.PortAType {Unsigned} CONFIG.PortBType {Signed} CONFIG.ClockEnable {true} CONFIG.Use_Custom_Output_Width {true} CONFIG.OutputWidthHigh {19}] [get_bd_cells Multiplier_4]


set_property -dict [list CONFIG.size {4}] [get_bd_cells Synapse_4]
