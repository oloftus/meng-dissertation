...
set_property -dict [list CONFIG.packetOutWidth {6} CONFIG.packetInWidth {25}] [get_bd_cells TypeRouter_Stimulus]
set_property -dict [list CONFIG.CONST_WIDTH {19} CONFIG.CONST_VAL {262144}] [get_bd_cells TypeRouter_Stimulus_Address]
...
set_property -dict [list CONFIG.NUM_PORTS {5} CONFIG.IN0_WIDTH {4} CONFIG.IN1_WIDTH {4} CONFIG.IN2_WIDTH {4} CONFIG.IN3_WIDTH {4} CONFIG.IN4_WIDTH {4}] [get_bd_cells SynOutConcat]
set_property -dict [list CONFIG.numInputs {5} CONFIG.dinWidth {4} CONFIG.doutWidth {32}] [get_bd_cells SynOutBuffer]
...
set_property -dict [list CONFIG.address {0} CONFIG.addressWidth {2} CONFIG.dataWidth {4}] [get_bd_cells StimulusRegister_0]


set_property -dict [list CONFIG.address {1} CONFIG.addressWidth {2} CONFIG.dataWidth {4}] [get_bd_cells StimulusRegister_1]


set_property -dict [list CONFIG.address {2} CONFIG.addressWidth {2} CONFIG.dataWidth {4}] [get_bd_cells StimulusRegister_2]
