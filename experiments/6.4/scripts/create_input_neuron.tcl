...
set_property -dict [list CONFIG.inputWidth {10} CONFIG.numInputs {4}] [get_bd_cells SumJunction]
...
set_property -dict [list CONFIG.NUM_PORTS {4} CONFIG.IN0_WIDTH {10} CONFIG.IN1_WIDTH {10} CONFIG.IN2_WIDTH {10} CONFIG.IN3_WIDTH {10}] [get_bd_cells SumJunctionConcat]
