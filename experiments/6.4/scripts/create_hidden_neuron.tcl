...
set_property -dict [list CONFIG.address {0} CONFIG.addressWidth {3} CONFIG.dataWidth {16} CONFIG.padHighWidth {-3} CONFIG.padLowWidth {-3}] [get_bd_cells BiasRegister]


set_property -dict [list CONFIG.DIN_WIDTH {10} CONFIG.DIN_FROM {7} CONFIG.DIN_TO {0}] [get_bd_cells PlanSlicer]
...
set_property -dict [list CONFIG.integerPrecision {2} CONFIG.fractionPrecision {7}] [get_bd_cells Plan]


set_property -dict [list CONFIG.address {1} CONFIG.addressWidth {3} CONFIG.dataWidth {16}] [get_bd_cells WeightRegister_0]


set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {19} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_0]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {19} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_1]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {19} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_2]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {19} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_3]
...
set_property -dict [list CONFIG.DIN_WIDTH {24} CONFIG.DIN_FROM {19} CONFIG.DIN_TO {10}] [get_bd_cells MultiplierSlicer_4]
