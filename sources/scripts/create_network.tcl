...
set_property -dict [list CONFIG.CONST_WIDTH {5} CONFIG.CONST_VAL {1}] [get_bd_cells LayerRouter_0_Address]
set_property -dict [list CONFIG.n {2}] [get_bd_cells DoneOut_Layer_0]

set_property -dict [list CONFIG.CONST_WIDTH {6} CONFIG.CONST_VAL {1}] [get_bd_cells Neuron_0_0_Address]

set_property -dict [list CONFIG.CONST_WIDTH {6} CONFIG.CONST_VAL {2}] [get_bd_cells Neuron_0_1_Address]

set_property -dict [list CONFIG.packetOutWidth {26} CONFIG.packetInWidth {31}] [get_bd_cells LayerRouter_1]
set_property -dict [list CONFIG.CONST_WIDTH {5} CONFIG.CONST_VAL {2}] [get_bd_cells LayerRouter_1_Address]
...
set_property -dict [list CONFIG.CONST_WIDTH {6} CONFIG.CONST_VAL {2}] [get_bd_cells Neuron_1_0_Address]

set_property -dict [list CONFIG.address {1} CONFIG.addressWidth {19} CONFIG.dataWidth {13}] [get_bd_cells StimulusRegister_0]
set_property -dict [list CONFIG.address {2} CONFIG.addressWidth {19} CONFIG.dataWidth {13}] [get_bd_cells StimulusRegister_1]
...
connect_bd_net [get_bd_pins Neuron_1_0_Address/dout] [get_bd_pins Neuron_1_1/NEURON_ADDR]
...
connect_bd_net [get_bd_pins Neuron_1_1_Address/dout] [get_bd_pins Neuron_1_0/NEURON_ADDR]
