...
end Network0_wrapper;

architecture STRUCTURE of Network0_wrapper is
  component Network0 is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component Network0;
begin
Network0_i: component Network0
    port map (
